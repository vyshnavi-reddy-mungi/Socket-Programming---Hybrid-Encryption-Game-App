...
public class TeluguTestcases {
    ...
    private static String fetchTeluguString(String inputText) throws IOException {
...
private static String getPresentString(Map<String, ArrayList<String>> verbList, String verb, String tense,
    ...
    else
    {
        if(subject.equals("3s"))
            {
                try{
                // InputStream inputStream = SwahiliTestCases.class.getResourceAsStream("E:\\PSD development branch\\Language-learning-app-PSD-project\\Language-learning-app\\Source code\\Back end\\lang_learning_app\\src\\main\\java\\group1\\langlearning\\utils\\3s-present verbs.txt");
...
private static String getNegativeString(Map<String, ArrayList<String>> verbList,String verb, String tense, String subject) {
    ...
    public static  EnglishSentenceRequestModel generateRequestModel(EnglishSentenceRequestModel requestModel, String srcString)
    {
...
class EnglishSentenceRequestModel {
